...
map *create_map1() {
    ...
    // add coins
	add_block(map1, 4, 12, TYPE_COIN);
	add_block(map1, 7, 12, TYPE_COIN);
	add_block(map1, 10, 12, TYPE_COIN);
	add_block(map1, 13, 12, TYPE_COIN);
	add_block(map1, 4, 47, TYPE_COIN);
	add_block(map1, 7, 47, TYPE_COIN);
	add_block(map1, 10, 47, TYPE_COIN);
	add_block(map1, 13, 47, TYPE_COIN);

	add_block(map1, 4, 17, TYPE_COIN);
	add_block(map1, 8, 16, TYPE_COIN);
	add_block(map1, 12, 17, TYPE_COIN);
	add_block(map1, 4, 42, TYPE_COIN);
	add_block(map1, 8, 43, TYPE_COIN);
	add_block(map1, 12, 42, TYPE_COIN);
		
	add_block(map1, 11, 20, TYPE_COIN);
	add_block(map1, 6, 21, TYPE_COIN);
	add_block(map1, 11, 39, TYPE_COIN);
	add_block(map1, 6, 38, TYPE_COIN);
		
	add_block(map1, 1, 21, TYPE_COIN);
	add_block(map1, 1, 38, TYPE_COIN);
	add_block(map1, 1, 29, TYPE_COIN);
		
	add_block(map1, 7, 28, TYPE_COIN);
	add_block(map1, 8, 31, TYPE_COIN);


	add_block(map1, 16, 21, TYPE_COIN);

	add_block(map1, 16, 38, TYPE_COIN);

	add_block(map1, 18, 1, TYPE_COIN);
    add_block(map1, 18, 58, TYPE_COIN);
	add_block(map1, 18, 8, TYPE_COIN);
	add_block(map1, 18, 17, TYPE_COIN);
	add_block(map1, 18, 25, TYPE_COIN);
	add_block(map1, 18, 51, TYPE_COIN);
	add_block(map1, 18, 42, TYPE_COIN);
	add_block(map1, 18, 34, TYPE_COIN);
	
	add_block(map1, 15, 27, TYPE_COIN);
	add_block(map1, 15, 32, TYPE_COIN);

	add_block(map1, 15, 1, TYPE_COIN);
	add_block(map1, 15, 58, TYPE_COIN);
...
map *create_map2() {
    ...
    // add coins
    add_block(map2, 1, 1, TYPE_COIN);
    add_block(map2, 4, 2, TYPE_COIN);
    add_block(map2, 8, 1, TYPE_COIN);
    add_block(map2, 12, 2, TYPE_COIN);
    add_block(map2, 1, 12, TYPE_COIN);
    add_block(map2, 3, 10, TYPE_COIN);
    add_block(map2, 7, 9, TYPE_COIN);
    add_block(map2, 9, 9, TYPE_COIN);
    add_block(map2, 11, 13, TYPE_COIN);
    add_block(map2, 2, 23, TYPE_COIN);
    add_block(map2, 4, 20, TYPE_COIN);
    add_block(map2, 7, 16, TYPE_COIN);
    add_block(map2, 12, 19, TYPE_COIN);
    add_block(map2, 16, 10, TYPE_COIN);
    add_block(map2, 18, 9, TYPE_COIN);
    add_block(map2, 18, 18, TYPE_COIN);
    add_block(map2, 18, 27, TYPE_COIN);
    add_block(map2, 16, 30, TYPE_COIN);
    add_block(map2, 14, 26, TYPE_COIN);
    add_block(map2, 14, 33, TYPE_COIN);
    add_block(map2, 8, 28, TYPE_COIN);
    add_block(map2, 8, 31, TYPE_COIN);
    add_block(map2, 4, 40, TYPE_COIN);
    add_block(map2, 4, 32, TYPE_COIN);
    add_block(map2, 4, 44, TYPE_COIN);
    add_block(map2, 11, 44, TYPE_COIN);
    add_block(map2, 14, 41, TYPE_COIN);
    add_block(map2, 18, 40, TYPE_COIN);
    add_block(map2, 18, 50, TYPE_COIN);
    add_block(map2, 5, 58, TYPE_COIN);
    add_block(map2, 10, 57, TYPE_COIN);
    add_block(map2, 15, 58, TYPE_COIN);
...
map *create_map3() {
    ...
    add_block(map3, 17, 2, TYPE_COIN);
    add_block(map3, 13, 9, TYPE_COIN);
    add_block(map3, 14, 3, TYPE_COIN);
    add_block(map3, 15, 7, TYPE_COIN);
    add_block(map3, 17, 57, TYPE_COIN);
    add_block(map3, 13, 50, TYPE_COIN);
    add_block(map3, 14, 56, TYPE_COIN);
    add_block(map3, 15, 52, TYPE_COIN);

    add_block(map3, 18, 15, TYPE_COIN);
    add_block(map3, 18, 28, TYPE_COIN);
    add_block(map3, 13, 27, TYPE_COIN);
    add_block(map3, 8, 28, TYPE_COIN);
	
    add_block(map3, 18, 44, TYPE_COIN);
    add_block(map3, 18, 31, TYPE_COIN);
    add_block(map3, 13, 32, TYPE_COIN);
    add_block(map3, 8, 31, TYPE_COIN);
	
    add_block(map3, 16, 22, TYPE_COIN);
    add_block(map3, 16, 37, TYPE_COIN);

    add_block(map3, 12, 23, TYPE_COIN);
    add_block(map3, 12, 36, TYPE_COIN);
	
    add_block(map3, 5, 23, TYPE_COIN);
    add_block(map3, 3, 21, TYPE_COIN);
    add_block(map3, 5, 36, TYPE_COIN);
    add_block(map3, 3, 38, TYPE_COIN);
	
    add_block(map3, 1, 10, TYPE_COIN);
    add_block(map3, 2, 5, TYPE_COIN);
    add_block(map3, 3, 7, TYPE_COIN);
    add_block(map3, 4, 3, TYPE_COIN);
    add_block(map3, 5, 5, TYPE_COIN);
    add_block(map3, 6, 1, TYPE_COIN);
	add_block(map3, 1, 49, TYPE_COIN);
    add_block(map3, 2, 54, TYPE_COIN);
    add_block(map3, 3, 52, TYPE_COIN);
    add_block(map3, 4, 56, TYPE_COIN);
    add_block(map3, 5, 54, TYPE_COIN);
    add_block(map3, 6, 58, TYPE_COIN);
    add_block(map3, 7, 10, TYPE_COIN);
    add_block(map3, 7, 49, TYPE_COIN);
    add_block(map3, 4, 16, TYPE_COIN);
    add_block(map3, 4, 43, TYPE_COIN);
